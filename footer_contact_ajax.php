...
if (is_post_request()) {
  ...
  if($name && $email && $message) {
    ...
    try { 
        ...
        //Recipients
        $mail->setFrom(EMAIL, 'MotherfuckinBob.com');
        $mail->addAddress(EMAIL, 'MotherfuckinBob.com Website');     // Add a recipient
        ...
        // Content
        $mail->isHTML(true);
        $mail->Subject = 'Email from MotherfuckinBob.com Website';
