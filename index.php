...
<head>
	...
	<title>THE Motherfuckin' Bob</title>
	<link rel="icon" type="image/ico" href="_images/favicon.ico">
	<meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
	<meta name="description" content="Hello, I'm Mothefuckin' Bob and you're motherfuckin' not.">
	<meta name="format-detection" content="telephone=no">

    <meta property="og:url" content="http://www.motherfuckinbob.com" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="THE Motherfuckin' Bob" />
    <meta property="og:image" content="http://www.motherfuckinbob.com/_images/the-motherfuckin-bob.jpg?<?php echo time(); ?>" />
    <meta property="og:image:alt" content="Motherfuckin Bob" />
    <meta property="og:description" content="Hello, I'm Motherfuckin' Bob and you're motherfuckin' not." />
    ...
    <!-- Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-140046709-2"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-140046709-2');
    </script>
...
<div id="wrapper">
    ...
    <?php
        ...
        $fields_string = '';
        $fields = array(
            'secret' => '6LfnH6MUAAAAAOTPsEd4EFa2mk7DhJKXkOPRoeX3',
    ...
    <?php
        ...
        $subject = "Message From MotherfuckinBob.com Website";
...
<div id="contact-wrapper" class="cf">
        <img class="click-box-01 bob-twirl" src="_images/the-motherfuckin-bob.jpg">
        ...
        <div id="box-01" class="foo">
            <form action="" method="post" id="contactForm" onSubmit="return validateEmail(document.forms[0].email.value);">  
                ...
                <ul>
                  ...
                  <li>
                    <div class="g-recaptcha" data-theme="dark" data-callback="recaptchaCallback" data-sitekey="6LfnH6MUAAAAAGq490v9UliCxukU2-gWQcRwWZ4S"></div>
                  </li>
                  <li>
